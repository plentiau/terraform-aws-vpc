...
| <a name="input_intra_subnet_route_table_per_az"></a> [intra\_subnet\_route\_table\_per\_az](#input\_intra\_subnet\_route\_table\_per\_az) | Create a route table per AZ for intra subnets | `bool` | `false` | no |
...
| <a name="input_public_subnet_route_table_per_az"></a> [public\_subnet\_route\_table\_per\_az](#input\_public\_subnet\_route\_table\_per\_az) | Create a route table per AZ for public subnets | `bool` | `false` | no |
